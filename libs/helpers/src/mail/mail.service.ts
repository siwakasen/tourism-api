      ...
      const htmlTemplate = `
            <!DOCTYPE html>
                ...
                <div class="container">
                    ...
                    <div class="cta">
                        <a href="https://api.whatsapp.com/send/?phone=6281338364818&text=Hello%2C%0A%0AI+just+booked+for+%2A${payload.package_name}%2A.%0AName+of+booker%3A%20%2A${payload.name}%2A.%0AI+look+forward+to+your+confirmation.%0A%0AThank+you&type=phone_number&app_absent=0">Contact via WhatsApp</a>
                    </div>
                    </div>
                    <div class="footer">
                    <p>&copy; 2025 Ride Bali Explore. All Rights Reserved.</p>
      ...
      const htmlTemplate = `
            <!DOCTYPE html>
                ...
                <div class="container">
                    ...
                    <p>If you have any questions or need further assistance, please contact us via WhatsApp.</p>
                    <div class="cta">
                        <a href="https://api.whatsapp.com/send/?phone=6281338364818&text=Hello%2C%0A%0AI+just+booked+for+%2A${payload.car_name}%2A.%0AName+of+booker%3A%20%2A${payload.name}%2A.%0AI+look+forward+to+your+confirmation.%0A%0AThank+you&type=phone_number&app_absent=0">Contact via WhatsApp</a>
                    </div>
                    </div>
                    <div class="footer">
                    <p>&copy; 2025 Ride Bali Explore. All Rights Reserved.</p>
